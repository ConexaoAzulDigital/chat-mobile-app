...
export default ({ config }: ConfigContext): ExpoConfig => {
  return {
    ...
    ios: {
      supportsTablet: true,
      bundleIdentifier: 'com.conexaoazul.magicachat',
      infoPlist: {
      ...
      associatedDomains: ['applinks:chat.conexaoazul.com'],
    },
    android: {
      adaptiveIcon: { foregroundImage: './assets/adaptive-icon.png', backgroundColor: '#ffffff' },
      package: 'com.conexaoazul.magicachat',
    ...
    extra: {
      eas: {
        projectId: process.env.EXPO_PUBLIC_PROJECT_ID || '2a9ff588-2989-4260-b49a-0ddc8c493ab1',
